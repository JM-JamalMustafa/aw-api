...
YOUR_JWT_TOKEN= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmcmVzaCI6ZmFsc2UsImlhdCI6MTczMzc0Mzk2NiwianRpIjoiODRmM2YzNDEtOWVjNy00ZWI3LTgxZTgtNThhNjA4YzljZDQ4IiwidHlwZSI6ImFjY2VzcyIsInN1YiI6IkFobWFkIiwibmJmIjoxNzMzNzQzOTY2LCJjc3JmIjoiYWI2NjUyNDEtZjlmZS00YzQzLWE3MGEtMWI3YjRmMmMxZGM0IiwiZXhwIjoxNzMzNzcyNzY2fQ.zZYBtIvxlDo_Qzh29a81CNKbatQqT79tOfPeybivDl8"
# Fetch data from the API
def fetch_data():
    try:
        # Replace with your actual API endpoint and JWT token
        url = "http://192.168.1.5:8000/api/fetch"  # Replace this with your API
        headers = {
